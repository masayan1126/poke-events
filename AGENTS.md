...
- Evaluator: when GIRAFULLなんば店 is involved, verify that `venue_checks.girafull_namba_x.target_day_events` contains the X-derived event details that should be reported to the user.
